...
2. Route public API contracts to crate README files, rustdocs, examples, and
   public skills. Keep implementation rationale near code, Rust tests, trybuild
   fixtures, or short comments.
...
- `examples/bevy`
  Audience: **User-facing**
  Role: Bevy screenshot runtime example and source of checked-in captures under
...
- When public workflows, derive or attribute syntax, environment variables,
  ...
  the root README, affected crate README files, examples, rustdocs, tests,
  captures, public skills, and this guide when they name the changed behavior.
